...
#
#     if files.exists('/etc/etcd/etcd.conf'):
#         sudo('rm /etc/etcd/etcd.conf')
...
#     """,use_sudo=True)
#
#     if files.exists('/etc/kubernetes/apiserver'):
#         sudo('rm /etc/kubernetes/apiserver')
...
#     """,use_sudo=True)
#
#     if files.exists('/etc/kubernetes/controller-manager'):
#         sudo('rm /etc/kubernetes/controller-manager')
#     files.append("/etc/kubernetes/controller-manager", """
# KUBE_CONTROLLER_MANAGER_ARGS=""
#     """,use_sudo=True)
#
#     if files.exists('/etc/kubernetes/scheduler'):
#         sudo('rm /etc/kubernetes/scheduler')
